...
public class CCRCounterpartylist {
	...
	@Test(enabled = true)
	public void testcounterpartylistPageAPIs() {
		// call app meta--
		...
		// call layout--
		String layoutCallPayloadString = "{\"appId\":\"5539617b-5075-4482-8bcc-26f76849eb89\",\"workFlowTask\":\"counterpartylist\",\"payLoadData\":\"\"}";
		...
		// call data--
		String dataCallPayloadString = "{\"appId\":\"5539617b-5075-4482-8bcc-26f76849eb89\",\"workFlowTask\":\"counterpartylist\"}";
		Response dataResponse = callAPI(Method.POST, "/workflow/data",
				generatePayloadFromString(dataCallPayloadString));dataResponse.getBody().asString();
