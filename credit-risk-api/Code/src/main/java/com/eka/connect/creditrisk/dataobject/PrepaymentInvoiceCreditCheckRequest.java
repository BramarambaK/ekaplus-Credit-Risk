...
@ApiModel(description = "Credit Risk check api model for Pre Payment Invoice creation..")
public class PrepaymentInvoiceCreditCheckRequest {
	...
	@Pattern(regexp = "Purchase", flags = { Flag.CASE_INSENSITIVE }, message = "contractType values should be 'Purchase'")
	...
	private @Valid List<PrepaymetContractDetails> contractDetails;
	...
	public List<PrepaymetContractDetails> getContractDetails() {
		return contractDetails;
	}

	public void setContractDetails(
			List<PrepaymetContractDetails> contractDetails) {
